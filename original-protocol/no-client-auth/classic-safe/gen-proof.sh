...
load original-protocol/no-client-auth/classic-safe/inputs/input-scrused-lm.cafe .
load original-protocol/no-client-auth/classic-safe/inputs/input-se-lm.cafe .
q
q
EOF
echo "Finished!"