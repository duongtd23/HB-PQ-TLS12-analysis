...
load original-protocol/with-client-auth/classic-safe/inputs/input-auth-lm.cafe .
load original-protocol/with-client-auth/classic-safe/inputs/input-knl-lm.cafe .
load original-protocol/with-client-auth/classic-safe/inputs/input-scrused-lm.cafe .
